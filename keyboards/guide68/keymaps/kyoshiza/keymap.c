...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * ├────┬──┴─┬─┴──┬┴───┴┬──┴──┬┘  ┌┴───┴┬──┴─┬─┴──┬┴───┼───┼───┼───┤
     * │ L1     │  LGUI  │  LAlt  │   Spc    │  RCtrl   │    │   Spc    │  Spc   │  RAlt  │  RGUI  │  ←  │  ↓  │  →  │
     * └────┴────┴────┴─────┴─────┘    └─────┴────┴────┴────┴───┴───┴───┘
     */
    [0] = LAYOUT(
        ...
        MO(1),    KC_LGUI,   KC_LALT,           KC_SPC, KC_RCTL, KC_SPC, KC_SPC,         KC_RALT, KC_RGUI, KC_LEFT,KC_DOWN,KC_RGHT
    ),
    [1] = LAYOUT(
        KC_GRV,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,    KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_UNDS,  KC_F12,KC_TRNS,KC_DEL,
